...
milestones:
  ...
  - [x] /archive command + compact archived-project cards on the overview
  - [x] Pending-changes panel on project page (uncommitted files + unpushed commits)
